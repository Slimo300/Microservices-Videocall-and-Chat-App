...
func (_m *MockStorage) GetPresignedPutRequests(_a0 string, _a1 ...FileInput) ([]FileOutput, error) {
	...
	var r0 []FileOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(string, ...FileInput) ([]FileOutput, error)); ok {
		return rf(_a0, _a1...)
	}
	if rf, ok := ret.Get(0).(func(string, ...FileInput) []FileOutput); ok {
		r0 = rf(_a0, _a1...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]FileOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(string, ...FileInput) error); ok {
		r1 = rf(_a0, _a1...)
	} else {
		r1 = ret.Error(1)
	}
