...
// 	imageStorage := new(mockstorage.MockStorage)
// 	imageStorage.On("UploadFile", mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(nil)
// 	imageStorage.On("DeleteFile", mock.Anything, mock.Anything).Return(nil)
