...
// 	userOK := models.MustNewUser("host@net.pl", "user0", "password")

// 	db.On("SignIn", "host@net.pl", "password12").Return(userOK, nil)
...
// 	s.server = handlers.NewTestServer(app.NewTestApplication())
// }
