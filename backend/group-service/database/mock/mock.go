...
// MockGroupDB is an autogenerated mock type for the DBlayer type
type MockGroupDB struct {
	mock.Mock
}

// AddInvite provides a mock function with given fields: issID, targetID, groupID
func (_m *MockGroupDB) AddInvite(issID uuid.UUID, targetID uuid.UUID, groupID uuid.UUID) (models.Invite, error) {
...
func (_m *MockGroupDB) AnswerInvite(userID uuid.UUID, inviteID uuid.UUID, answer bool) (*models.Invite, *models.Group, *models.Member, error) {
...
func (_m *MockGroupDB) CreateGroup(userID uuid.UUID, name string) (models.Group, error) {
...
func (_m *MockGroupDB) DeleteGroup(userID uuid.UUID, groupID uuid.UUID) (models.Group, error) {
...
func (_m *MockGroupDB) DeleteGroupProfilePicture(userID uuid.UUID, groupID uuid.UUID) (string, error) {
	ret := _m.Called(userID, groupID)
...
func (_m *MockGroupDB) DeleteMember(userID uuid.UUID, groupID uuid.UUID, memberID uuid.UUID) error {
...
func (_m *MockGroupDB) GetGroupProfilePictureURL(userID uuid.UUID, groupID uuid.UUID) (string, error) {
	ret := _m.Called(userID, groupID)
...
func (_m *MockGroupDB) GetUserGroups(id uuid.UUID) ([]models.Group, error) {
	ret := _m.Called(id)
...
// GetUserInvites provides a mock function with given fields: userID
func (_m *MockGroupDB) GetUserInvites(userID uuid.UUID) ([]models.Invite, error) {
...
func (_m *MockGroupDB) GrantRights(userID uuid.UUID, groupID uuid.UUID, memberID uuid.UUID, rights models.MemberRights) (*models.Member, error) {
...
func (_m *MockGroupDB) NewUser(event events.UserRegisteredEvent) error {
	ret := _m.Called(event)
...
type mockConstructorTestingTNewMockGroupDB interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockGroupDB creates a new instance of MockGroupDB. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockGroupDB(t mockConstructorTestingTNewMockGroupDB) *MockGroupDB {
	mock := &MockGroupDB{}
	mock.Mock.Test(t)
