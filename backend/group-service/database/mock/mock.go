...
func (_m *MockGroupsDB) AnswerInvite(userID uuid.UUID, inviteID uuid.UUID, answer bool) (*models.Invite, *models.Group, *models.Member, error) {
	...
	var r3 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, uuid.UUID, bool) (*models.Invite, *models.Group, *models.Member, error)); ok {
...
func (_m *MockGroupsDB) DeleteMember(userID uuid.UUID, groupID uuid.UUID, memberID uuid.UUID) (*models.Member, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, uuid.UUID, uuid.UUID) (*models.Member, error)); ok {
		return rf(userID, groupID, memberID)
	}
...
func (_m *MockGroupsDB) GetUser(userID uuid.UUID) (models.User, error) {
...
func (_m *MockGroupsDB) GrantRights(userID uuid.UUID, groupID uuid.UUID, memberID uuid.UUID, rights models.MemberRights) (*models.Member, error) {
	...
	var r0 *models.Member
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, uuid.UUID, uuid.UUID, models.MemberRights) (*models.Member, error)); ok {
		return rf(userID, groupID, memberID, rights)
	}
